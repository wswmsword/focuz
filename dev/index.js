...
(function(l, r) { if (!l || l.getElementById('livereloadscript')) return; r = l.createElement('script'); r.async = 1; r.src = '//' + (self.location.host || 'localhost').split(':')[0] + ':2310/livereload.js?snipver=1'; r.id = 'livereloadscript'; l.getElementsByTagName('head')[0].appendChild(r) })(self.document);
var focusky = (function () {
  'use strict';
  ...
  /** 参数是否是对象 */
  const isObj = obj => objToStr(obj) === "[object Object]";
